...
use gsw_mod_toolbox, only : gsw_pot_enthalpy_ice_freezing
use gsw_mod_toolbox, only : gsw_pot_enthalpy_ice_freezing_first_derivatives
...
!--------------------------------------------------------------------------
func0 = h_pot_bulk - &
               gsw_cp0*gsw_ct_freezing_exact(sa_bulk,p,saturation_fraction)
...
call gsw_pot_enthalpy_ice_freezing_first_derivatives(sa,p,dpot_h_ihf_dsa)
