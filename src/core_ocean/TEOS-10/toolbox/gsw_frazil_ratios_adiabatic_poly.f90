...
call gsw_t_freezing_first_derivatives_poly(sa,p,saturation_fraction,tf_sa,tf_p)
call gsw_ct_freezing_first_derivatives_poly(sa,p,saturation_fraction,ctf_sa,ctf_p)
