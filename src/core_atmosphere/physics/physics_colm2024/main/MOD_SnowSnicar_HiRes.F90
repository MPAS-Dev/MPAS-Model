         ...
         IF (mpas_is_root) THEN
            DO i=snl_top,snl_btm,1
               IF ((snw_rds_lcl(i) < snw_rds_min_tbl) .or. (snw_rds_lcl(i) > snw_rds_max_tbl)) THEN
                  ...
                  CALL CoLM_stop('SNICAR encountered inconsistent snow-layer state.')
               ENDIF
            ENDDO
         ENDIF
#endif
...
!H. Wang
              ...
              ! aerosol species 8 optical properties
               ...
               ELSEIF((trip == 1).and.(flg_dover == 4).and.(err_idx >= 20)) THEN
                 ...
                 IF (mpas_is_root) THEN
                    ...
                    CALL CoLM_stop('SNICAR aerosol concentration is outside its valid range.')
                 ENDIF
#endif
               ELSE
                  flg_dover = 0
            ...
            IF (abs(energy_sum) > 0.00001_r8) THEN
               ...
               IF (mpas_is_root) THEN
                  ...
                  CALL CoLM_stop('SNICAR energy conservation check failed.')
               ENDIF
#endif
            ENDIF
            ...
            IF (albout_lcl(bnd_idx) > 1.0) THEN
               ...
               IF (mpas_is_root) THEN
                  ...
                  CALL CoLM_stop('SNICAR snow-grain radius is outside its valid range.')
               ENDIF
#endif
            ENDIF
  ...
  !       )
      ...
      ELSE
         IF (mpas_is_root) THEN
            ...
            CALL CoLM_stop('SNICAR received an unsupported snow shape.')
         ENDIF
      ENDIF
      ...
      ELSE
         IF (mpas_is_root) THEN
            ...
            CALL CoLM_stop('SNICAR received an unsupported atmospheric profile.')
         ENDIF
      ENDIF
         ...
         IF (mpas_is_root) THEN
            DO i=snl_top,snl_btm,1
               IF ((snw_rds_lcl(i) < snw_rds_min_tbl) .or. (snw_rds_lcl(i) > snw_rds_max_tbl)) THEN
                  ...
                  write (iulog,*) " level: ", i, " snl(c)= ", snl_lcl
                  write (iulog,*) "h2osno(c)= ", h2osno_lcl
                  CALL CoLM_stop('SNICAR-AD encountered inconsistent snow-layer state.')
               ENDIF
            ENDDO
         ENDIF
   ...
   !H. Wang
            ...
            DO i=snl_top,snl_btm,1
              ...
              IF (mpas_is_root) THEN
                 IF (flx_abs_lcl(i,bnd_idx) < -0.00001) THEN
                    ...
                    CALL CoLM_stop('SNICAR-AD aerosol concentration is outside its valid range.')
                 ENDIF
              ENDIF
            ENDDO
            ...
            IF (mpas_is_root) THEN
               IF (abs(energy_sum) > 0.00001_r8) THEN
                  ...
                  CALL CoLM_stop('SNICAR-AD energy conservation check failed.')
               ENDIF
            ENDIF
            ...
            IF (mpas_is_root) THEN
               IF (albout_lcl(bnd_idx) > 1.0) THEN
                  ...
                  CALL CoLM_stop('SNICAR-AD snow-grain radius is outside its valid range.')
               ENDIF
            ENDIF
 ...
 !       )
         ...
         DO i = snl_top, snl_btm, 1
            ...
            ELSEIF ( dr_fresh < 0.0_r8 ) THEN
               IF (mpas_is_root) THEN
                  ...
                  CALL CoLM_stop('SNICAR snow-grain growth is negative.')
               ENDIF
            ENDIF
   ...
   !-----------------------------------------------------------------------
      ...
      ELSE
         IF (mpas_is_root) THEN
            write(iulog,*) "snicar_atm_type = ", snicar_atm_type
            CALL CoLM_stop('SNICAR-AD received an unsupported atmospheric profile.')
         ENDIF
      ENDIF
