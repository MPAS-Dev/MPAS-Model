!  SVN:$Id: ice_shortwave_modified.F90 1182 2017-03-16 19:29:26Z njeffery $
!=======================================================================
!
...
! 2005, WHL: Moved absorbed_solar from ice_therm_vertical_modified to this 
...
! 2013, ECH: merged with NCAR version, cleaned up
      ...
      module ice_shortwave_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c0, c1, c1p5, c2, c3, c4, c10, &
      ...
      use ice_colpkg_shared_modified, only: hi_ssl, hs_ssl, modal_aero, max_aero
      use ice_colpkg_shared_modified, only: hi_ssl, hs_ssl, modal_aero, rsnw_fall, &
          rsnw_tmax
...
! 2013 ECH merged with NCAR version
      ...
      use ice_orbital_modified, only: compute_coszen
...
! authors     Nicole Jeffery, LANL
      ...
      use ice_constants_colpkg_modified, only: c0, c1, c2, p5
      use ice_colpkg_tracers_modified, only: nt_bgc_N, nt_zaero, tr_bgc_N, &
          tr_zaero, nlt_chl_sw, nlt_zaero_sw
      use ice_colpkg_shared_modified, only: dEdd_algae, bgc_flux_type, sk_l, &
           R_chl2N, min_bgc, F_abs_chl,  hi_ssl
      use ice_zbgc_shared_modified, only: remap_zbgc
...
!=======================================================================
      ...
      end module ice_shortwave_modified
