!  SVN:$Id: ice_orbital_modified.F90 1175 2017-03-02 19:53:26Z akt $
!=======================================================================
...
! 2014 ECH: Moved routines from csm_share/shr_orb_mod.F90
      ...
      module ice_orbital_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c2, p5, pi, secday
...
! author:  Bruce P. Briegleb, NCAR 
      ...
      use ice_constants_colpkg_modified, only: eccen, mvelpp, lambm0, obliqr, decln, eccf
#ifdef CCSMCOUPLED
...
!-------------------------------------------------------------------------------
   ...
   "$Id: ice_orbital_modified.F90 1175 2017-03-02 19:53:26Z akt $"
...
!=======================================================================
      ...
      end module ice_orbital_modified
