!  SVN:$Id: ice_itd_modified.F90 1196 2017-04-18 13:32:23Z eclare $
!=======================================================================
...
! 2014 ECH: Converted to column package
      ...
      module ice_itd_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c0, c1, c2, p001, puny, p5, &
...
! author: William H. Lipscomb, LANL
      ...
      use ice_colpkg_tracers_modified, only: nt_Tsfc, nt_qice, nt_qsno, nt_aero, &
                             nt_apnd, nt_hpnd, nt_fbri, tr_brine, nt_bgc_S, &
                             bio_index
      use ice_colpkg_shared_modified, only:  solve_zsal, skl_bgc, z_tracers, min_salin, &
                             sk_l, rhosi
      use ice_zbgc_shared_modified, only: zap_small_bgc
...
!=======================================================================
      ...
      use ice_colpkg_tracers_modified, only: nt_qsno, nt_aero, bio_index
      use ice_colpkg_shared_modified, only: hs_ssl, z_tracers
...
!=======================================================================
      ...
      use ice_colpkg_tracers_modified, only: nt_qsno 
      use ice_therm_shared_modified, only: Tmin
...
! over k, making the test more stringent.
      ...
      use ice_colpkg_tracers_modified, only: nt_qice, nt_qsno
