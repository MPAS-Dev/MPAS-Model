!  SVN:$Id: ice_aerosol_modified.F90 1175 2017-03-02 19:53:26Z akt $
!=======================================================================
...
!         David Bailey, NCAR
      ...
      module ice_aerosol_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c0, c1, c2, puny, rhoi, rhos, hs_min
...
!  and vertical cycling
      ...
      use ice_colpkg_shared_modified, only: hi_ssl, hs_ssl, max_aero
      use ice_colpkg_tracers_modified, only: nt_aero 
...
!  and vertical cycling : after update_aerosol
      ...
      use ice_colpkg_shared_modified, only: hi_ssl, hs_ssl
      use ice_constants_colpkg_modified, only: c0, rhos, rhoi, hs_min, puny, &
                         c2, c1
      use ice_zbgc_shared_modified, only: kscavz 
...
!=======================================================================
      ...
      end module ice_aerosol_modified
