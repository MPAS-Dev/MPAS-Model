!  SVN:$Id: ice_snow_modified.F90 972 2015-04-15 19:44:20Z njeffery $
!=======================================================================
!
! authors Elizabeth Hunke, LANL
!         Nicole Jeffery, LANL

      module ice_snow_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: puny, c0, c1, c10, rhos, Lfresh, &
...
! thickness does not
      ...
      use ice_therm_vertical_modified, only: adjust_enthalpy
...
!  Snow grain metamorphism
      ...
      use ice_constants_colpkg_modified, only: c0, rhos, Tffresh, Lfresh, cp_ice, p5, puny, c10
      use ice_colpkg_shared_modified, only: idx_T_min, idx_Tgrd_min, idx_rhos_min
...
!  Snow grain metamorphism
    ...
    use ice_constants_colpkg_modified, only: c0, c1, c4, pi, p1, c100
    !
