!  SVN:$Id: ice_therm_mushy_modified.F90 1196 2017-04-18 13:32:23Z eclare $
!=======================================================================

module ice_therm_mushy_modified

  use ice_kinds_mod_modified
  use ice_constants_colpkg_modified, only: c0, c1, c2, c4, c8, c10, c1000, &
      p001, p01, p05, p1, p2, p5, pi, bignum, puny, ice_ref_salinity, &
      viscosity_dyn, rhow, rhoi, rhos, cp_ocn, cp_ice, Lfresh, gravit, &
      hs_min, ksno
  use ice_colpkg_shared_modified, only: a_rapid_mode, Rac_rapid_mode, &
      aspect_rapid_mode, dSdt_slow_mode, phi_c_slow_mode, phi_i_mushy

  use ice_therm_shared_modified, only: ferrmax
...
!=======================================================================
  ...
  subroutine temperature_changes_salinity(dt,                 &
    ...
    use ice_mushy_physics_modified, only: &
         enthalpy_brine, &
         temperature_mush, &
         liquid_fraction, &
         temperature_snow, &
...
!=======================================================================
  ...
  subroutine two_stage_inconsistency(type, Tsf, Tmlt, fcondtop, fsurfn)
    ...
    write(warning,*) "ice_therm_mushy_modified: two stage inconsistency"
    call add_warning(warning)
...
!=======================================================================
  ...
  subroutine picard_solver(nilyr,    nslyr,    &
    ...
    use ice_therm_shared_modified, only: surface_heat_flux, dsurface_heat_flux_dTsf
...
end module ice_therm_mushy_modified
