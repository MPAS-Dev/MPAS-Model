!  SVN:$Id: ice_colpkg_shared_modified.F90 1142 2016-08-27 16:07:51Z njeffery $
!=========================================================================
!
...
! authors: Elizabeth C. Hunke, LANL
      ...
      module ice_colpkg_shared_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c3, c0, c1, p5, p1
...
!-----------------------------------------------------------------------
      ...
      !-----------------------------------------------------------------
      ! From ice_zbgc_shared_modified.F90
      !-----------------------------------------------------------------
      ...
      !-----------------------------------------------------------------
      ! From algal_dyn in ice_algae_modified.F90
      !-----------------------------------------------------------------
...
!=======================================================================
      ...
      end module ice_colpkg_shared_modified
