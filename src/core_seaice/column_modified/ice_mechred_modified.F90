!  SVN:$Id: ice_mechred_modified.F90 1182 2017-03-16 19:29:26Z njeffery $
!=======================================================================
...
!       Converted to free source form (F90)
      ...
      module ice_mechred_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c0, c1, c2, c10, c20, c25, &
          p05, p15, p25, p333, p5, &
...
! author: William H. Lipscomb, LANL
      ...
      use ice_colpkg_tracers_modified, only: nt_qsno, nt_fbri, &
...
!=======================================================================
      ...
      end module ice_mechred_modified
