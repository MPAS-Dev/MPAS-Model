 !  SVN:$Id: ice_therm_bl99_modified.F90 1196 2017-04-18 13:32:23Z eclare $
!=========================================================================
!
...
!
! 2012: Split from ice_therm_vertical_modified.F90

      module ice_therm_bl99_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c0, c1, c2, p01, p1, p5, puny, &
          rhoi, rhos, hs_min, cp_ice, cp_ocn, depressT, Lfresh, ksno, kice
      use ice_colpkg_shared_modified, only: conduct, calc_Tsfc, solve_zsal
      use ice_therm_shared_modified, only: ferrmax, l_brine, hfrazilmin
...
!=======================================================================
      ...
      end module ice_therm_bl99_modified
