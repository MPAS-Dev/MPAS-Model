!  SVN:$Id: ice_flux_colpkg_modified.F90 1175 2017-03-02 19:53:26Z akt $
!=======================================================================
...
! 2014: Moved subroutines merge_fluxes, set_sfcflux from ice_flux.F90
      ...
      module ice_flux_colpkg_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c1, emissivity
...
!=======================================================================
      ...
      end module ice_flux_colpkg_modified
