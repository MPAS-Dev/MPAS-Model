...
! author Elizabeth C. Hunke, LANL
      ...
      module ice_colpkg_tracers_modified

      use ice_kinds_mod_modified
      use ice_colpkg_shared_modified, only: max_algae, max_dic, max_doc, max_don, &
...
! author: William H. Lipscomb, LANL
      ...
      use ice_constants_colpkg_modified, only: c0, c1, puny, Tocnfrz
...
!=======================================================================
      ...
      end module ice_colpkg_tracers_modified
