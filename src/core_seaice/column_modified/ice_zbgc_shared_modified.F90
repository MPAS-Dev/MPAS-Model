!  SVN:$Id: ice_zbgc_shared_modified.F90 1166 2017-02-12 22:56:19Z njeffery $
!=======================================================================
!
...
!
      module ice_zbgc_shared_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: p01, p1, p5, c0, c1
      use ice_colpkg_shared_modified, only: max_nbtrcr, max_algae, max_doc, &
      ...
      !-----------------------------------------------------------------
      ! From algal_dyn in ice_algae_modified.F90 but not in namelist
      !-----------------------------------------------------------------
...
!
      ...
      use ice_constants_colpkg_modified, only: c1, rhoi, cp_ocn, cp_ice, Lfresh  
...
! authors     Nicole Jeffery, LANL
      ...
      use ice_constants_colpkg_modified, only: c0, c1, p5, puny
...
!=======================================================================
      ...
      end module ice_zbgc_shared_modified
