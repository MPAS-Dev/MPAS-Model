!  SVN:$Id: ice_zbgc_modified.F90 1175 2017-03-02 19:53:26Z akt $
!=======================================================================
!
...
!
      module ice_zbgc_modified

      use ice_kinds_mod_modified
      use ice_zbgc_shared_modified ! everything
...
! Adjust biogeochemical tracers when new frazil ice forms
      ...
      use ice_constants_colpkg_modified, only: c0, c1, puny, depressT
      use ice_itd_modified, only: column_sum, &
                         column_conservation_check
      use ice_colpkg_tracers_modified, only: tr_brine, nt_fbri, nt_sice, nt_qice, nt_Tsfc
      use ice_colpkg_shared_modified, only: solve_zsal
...
! When sea ice melts laterally, flux bgc to ocean
      ...
      use ice_colpkg_tracers_modified, only: nt_fbri, nt_bgc_S, bio_index
      use ice_colpkg_shared_modified, only: solve_zsal, rhosi
      use ice_constants_colpkg_modified, only: c1, p001
...
! author: Nicole Jeffery, LANL
      ...
      use ice_constants_colpkg_modified, only: c1, c0
      use ice_colpkg_tracers_modified, only: nt_sice, nt_bgc_S, bio_index 
      use ice_colpkg_shared_modified, only: min_salin, salt_loss
...
!
      ...
      use ice_constants_colpkg_modified, only: c1, c0, p5, secday, puny
      use ice_colpkg_shared_modified, only: solve_zbgc, max_nbtrcr, hs_ssl, R_C2N, &
                             fr_resp, R_chl2N
      use ice_colpkg_tracers_modified, only: nt_bgc_N, nt_fbri, nlt_bgc_N
...
! author: Elizabeth C. Hunke and William H. Lipscomb, LANL
      ...
      use ice_constants_colpkg_modified, only: c1, secday, puny
      use ice_colpkg_tracers_modified, only: nt_bgc_N
      use ice_colpkg_shared_modified, only: sk_l, R_C2N, fr_resp, R_chl2N
