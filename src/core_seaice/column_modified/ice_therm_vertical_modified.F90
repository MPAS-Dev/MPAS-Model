!  SVN:$Id: ice_therm_vertical_modified.F90 1196 2017-04-18 13:32:23Z eclare $
!=========================================================================
!
...
!       Converted to free source form (F90)
      ...
      module ice_therm_vertical_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c0, c1, c3, p001, p5, puny, &
          pi, depressT, Lvap, hs_min, cp_ice, &
          cp_ocn, rhow, rhoi, rhos, Lfresh, rhofresh, ice_ref_salinity
      use ice_colpkg_shared_modified, only: ktherm, heat_capacity, calc_Tsfc, &
          min_salin, rsnw_fall, rsnw_tmax
      use ice_therm_shared_modified, only: ferrmax, l_brine, &
                                  calculate_tin_from_qin, Tmin
      use ice_therm_bl99_modified, only: temperature_changes
      use ice_therm_0layer_modified, only: zerolayer_temperature
...
!          C. M. Bitz, UW
      ...
      use ice_therm_mushy_modified, only: temperature_changes_salinity
...
! other 2D flux and energy variables
      ...
      ! aerosol flux is accounted for in ice_aerosol_modified.F90
      !-----------------------------------------------------------------
...
!         C. M. Bitz, UW
      ...
      use ice_constants_colpkg_modified, only: p1 !!!AKT Column!!!
...
!         C. M. Bitz, UW
      ...
      use ice_colpkg_shared_modified, only: phi_i_mushy
      use ice_mushy_physics_modified, only: enthalpy_mush, enthalpy_of_melting, &
...
!=======================================================================
      ...
      end module ice_therm_vertical_modified
