!  SVN:$Id: ice_therm_0layer_modified.F90 1196 2017-04-18 13:32:23Z eclare $
!=========================================================================
!
...
! 2012: Split from ice_therm_vertical_modified.F90
      ...
      module ice_therm_0layer_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: c0, c1, p5, puny, &
          kseaice, ksno
      use ice_therm_bl99_modified, only: surface_fluxes
...
!=======================================================================
      ...
      end module ice_therm_0layer_modified
