!  SVN:$Id: ice_firstyear_modified.F90 1099 2015-12-12 18:12:30Z eclare $
!=======================================================================
!
...
!
! authors C. Bitz, University of Washington, modified from ice_age_modified module
!
! 2012: E. Hunke adopted from CESM into CICE, changed name from ice_FY.F90
!
      module ice_firstyear_modified

      use ice_kinds_mod_modified
      use ice_constants_colpkg_modified, only: secday, c0
...
!=======================================================================
      ...
      end module ice_firstyear_modified
