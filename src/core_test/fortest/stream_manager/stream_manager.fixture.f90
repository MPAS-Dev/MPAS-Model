...
contains
   ...
   subroutine setup_allPackages_pool(f, allPackages, packages, package_names)
      ...
      call mpas_pool_create_pool(allPackages, 1)
   ...
   subroutine setup_allFields_pool(f, allFields, fields)
      ...
      allocate(allFields)
      call mpas_pool_create_pool(allFields, 1)
   ...
   subroutine setup_allStructs_pool(f, allStructs, structs, fields)
      ...
      allocate(allStructs)
      call mpas_pool_create_pool(structs(1)%pool, 1)
      call mpas_pool_create_pool(structs(2)%pool, 1)
      call mpas_pool_create_pool(structs(3)%pool, 1)
      call mpas_pool_create_pool(structs(4)%pool, 1)
      call mpas_pool_create_pool(structs(5)%pool, 1)
      call mpas_pool_create_pool(structs(6)%pool, 1)
      call mpas_pool_create_pool(allStructs, 1)
