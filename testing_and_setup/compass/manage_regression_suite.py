...
def write_local_parallel_bottom(local_parallel_code):
    ...
    local_parallel_code += "    if len(compleated) + len(failed) < len(testcase_data.keys()):\n"
    local_parallel_code += "        adding_phase = True\n"
    ...
    local_parallel_code += "                    print('we have enough to add: {}, {}, {}'.format(testcase_data[key]['procs'], number_of_procs, key))\n"
    local_parallel_code += "                else:\n"
    ...
    local_parallel_code += "                if error_out != 1:\n"
    local_parallel_code += "                    print('Failed: {} '.format(running_key))\n"
    local_parallel_code += "                    failed.append(running_key)\n"
    local_parallel_code += "                else:\n"
    local_parallel_code += "                    print('Passed: {}'.format(running_key))\n"
    local_parallel_code += "                    compleated.append(runnning_key)\n"
...
def write_script_bottom(regression_script_code):
    ...
    regression_script_code += "print('runtime: {}'.format(runtime))\n"
